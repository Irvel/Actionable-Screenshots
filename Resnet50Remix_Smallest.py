...
def ResNet50(input_shape=(64, 64, 3), classes=6):
    ...
    # Stage 3
    X = convolutional_block(X, f=3, filters=[128, 256, 256], stage=5, block='a', s=2)
    X = identity_block(X, 3, [128, 256, 256], stage=5, block='b')
    X = identity_block(X, 3, [128, 256, 256], stage=5, block='c')
    X = identity_block(X, 3, [128, 256, 256], stage=5, block='d')
    ...
    # Create model
    model = Model(inputs=X_input, outputs=X, name='ResNet50Smaller')
